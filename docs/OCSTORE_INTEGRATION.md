...
## Натяжка HTML-шаблона «Эврика» на OcStore (OpenCart 3)
...
**Задача:** перенести готовую HTML-верстку в полноценную тему OcStore, соблюдая все дизайн-правила из `DESIGN_SYSTEM.md`.
...
Строго соблюдай эту последовательность — каждый этап зависит от предыдущего.
...
### ЭТАП 3 — Страница категории (самая сложная)
